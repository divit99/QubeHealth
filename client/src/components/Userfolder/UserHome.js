...
const UserHome = () => {
    ...
    const getUserData = async () => {
        const res = await axios.get(`/getdata/${params.id}`, {
            headers: {
    ...
    return (
        <>
            ...
            <div className="container mt-2">
                <h1 className='text-center mt-2'>Upload Image</h1>
                <div className='text-end'>
                    <Button variant="primary" style={{ marginBottom: "20px" }}><NavLink to={`/`} className="text-decoration-none text-light"> Logout</NavLink></Button>
                </div>
                <div className='text-end'>
                    <Button variant="primary" ><NavLink to={`/UserAdd/${params.id}`} className="text-decoration-none text-light"> Add User</NavLink></Button>
                </div>
